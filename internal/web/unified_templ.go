			...
			if len(data.Events) == 0 {
				...
				for _, e := range data.Events {
					...
					if e.TraceID != "" {
						...
						templ_7745c5c3_Var36, templ_7745c5c3_Err = templ.JoinURLErrs(templ.SafeURL(withWindow("/traces/"+pathEscape(e.TraceID), data.Window)))
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/unified.templ`, Line: 162, Col: 92}
						}
