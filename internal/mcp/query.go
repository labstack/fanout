		...
		Views: []ViewSchema{
			{
				...
				Columns: []ColumnInfo{
					...
					{Name: "resource", Type: "VARCHAR", Description: "Resource attributes (JSON)"},
					{Name: "attributes", Type: "VARCHAR", Description: "Span attributes (JSON)"},
					{Name: "tenant_id", Type: "VARCHAR", Description: "Tenant identifier"},
				},
			},
			{
				Name: "logs",
				Columns: []ColumnInfo{
					...
					{Name: "resource", Type: "VARCHAR", Description: "Resource attributes (JSON)"},
					{Name: "attributes", Type: "VARCHAR", Description: "Log attributes (JSON)"},
					{Name: "tenant_id", Type: "VARCHAR", Description: "Tenant identifier"},
				},
			},
			{
				...
				Columns: []ColumnInfo{
					...
					{Name: "attributes", Type: "VARCHAR", Description: "Metric attributes (JSON)"},
					{Name: "resource", Type: "VARCHAR", Description: "Resource attributes (JSON)"},
					{Name: "tenant_id", Type: "VARCHAR", Description: "Tenant identifier"},
				},
			},
