      ...
      <div className="grid gap-2 w-full max-w-lg">
        {suggestions.map((s) => (
          <button
            ...
            className="group flex items-center justify-between gap-3 px-4 py-2.5 text-[13px] text-left rounded-lg border border-border/60 bg-surface-1/80 hover:bg-surface-2 hover:border-border transition-all duration-150"
          >
