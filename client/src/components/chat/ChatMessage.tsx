...
export function ChatMessage({ message }: { message: Message }) {
  ...
  if (message.role === "user") {
    return (
      <div className="flex justify-end">
        <div className="bg-primary text-primary-foreground rounded-[14px] rounded-br-[4px] px-4 py-2.5 max-w-[80%] text-[14px] leading-relaxed font-medium">
          {message.content}
        </div>
      </div>
    );
  ...
  return (
    <div className="flex gap-3">
      <div className="shrink-0 mt-0.5 flex items-center justify-center h-7 w-7 rounded-lg bg-primary/15 border border-primary/10">
