...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines: string[] = [
    ...
    "over gRPC and HTTP, writes telemetry to disk as Parquet, answers queries with",
    "DuckDB, evaluates alert rules, serves a chat investigator and MCP tools, and",
    "hosts the browser client. There is no collector to deploy alongside it and no",
    "database to operate.",
    "",
