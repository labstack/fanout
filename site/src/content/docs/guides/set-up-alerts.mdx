...
| Variable | Is |
|---|---|
| `error_rate` | Errors as a proportion of requests |
| `p50`, `p95` | Latency percentiles |
| `throughput` | Requests per second |
| `log_count` | Log volume |
| `z_score` | Deviation from the service's own baseline |
| `health_score` | Composite health |
| `error_rate_delta`, `p95_delta`, `throughput_delta` | Change against baseline |
