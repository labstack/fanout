...
Self-provisioned users are `viewer`, which is the point: they can read telemetry
and keep their own dashboards, and cannot run the agent or change anything. See
