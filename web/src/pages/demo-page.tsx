...
const blocks: { title: string; description: string; block: Block }[] = [
  ...
  {
    title: "Comparison",
    description: "Before/after comparison with change direction, percentages, and statistical significance",
    block: {
      type: "comparison",
      data: {
        mode: "time",
    ...
    <PageContainer>
      <div className="mx-auto max-w-5xl">
        <PageHeader
          ...
          subtitle={`${blocks.length} block types`}
          actions={
            ...
            <section key={i} id={title.toLowerCase().replace(/\s+/g, "-")}>
              <div className="mb-3">
                <div className="mb-0.5 flex items-center gap-2.5">
                  ...
                  <code className="rounded bg-surface-2 px-2 py-0.5 font-mono text-[11px] text-muted-foreground">
                    {block.type}
                  </code>
                </div>
