...
`)
	...
	assertFloat(t, "lake partitions delta", report.ParquetFilesDelta, 2)
	assertFloat(t, "lake size delta", report.ParquetSizeBytesDelta, 80)
	assertFloat(t, "lake growth rate", report.ParquetGrowthBytesPerSec, 10)
